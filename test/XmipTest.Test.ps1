...
Describe 'The environment a roll is started with' {
    ...
    It 'names a test for every scenario the roll drives, and nothing the roll does not' {
        ...
        [string] $scenarios = Join-Path $script:Root 'module/core/test/playground/src/scenario.rs'
    ...
    It 'reads every variable the roll documents' {
        ...
        [string] $roll = @(
            'module/core/test/playground/src/bin/roll.rs'
            'module/core/test/playground/src/environment.rs'

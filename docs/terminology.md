...
| **Xmip Playground** | The tool that exercises Xmip. It spawns Development nodes as System Processes on one machine — no virtualisation — and drives every transport and every content contract through them continuously: Receive Locations fed, Send Locations watched, a verdict per pair published as health. It is where a transport or contract is proven, and the source of real measurement. Named by the owner, 2026-09-05; ADR-0028. |

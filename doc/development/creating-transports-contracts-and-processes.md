...
| --- | --- |
| A transport (Kafka, MQTT, S3 ...) | `module/capability/transport/doc/adding-a-transport.md` |
| A contract (CSV, JSON, EDIFACT ...) | `module/capability/contract/doc/adding-a-contract.md` |

# ADR-0023: AGPL-3.0-or-later, and no second license
...
- Subject: AGPL-3.0-or-later, and no second license
- Name: AGPL-3.0-or-later
- Order: 3
- Concepts: License, AGPL, dual licensing, CLA
...
answers whether the *module boundary* carries a license exception, not why Xmip
...
**Xmip is AGPL-3.0-or-later. There is no commercial license and no dual
licensing.**

## Why

**A platform that cannot be relicensed cannot be closed.** This is the whole of
it. On 2025-03-19 NextGen moved Mirth Connect to a single commercial license at
...
Dual licensing is the mechanism that makes it possible. Holding a second license
...
Xmip under Xmip's license and may additionally have to satisfy the licenses of
...
- **No contributor license agreement is needed.** A CLA exists to let a project
  grant a license it could not otherwise grant. With one license there is
  ...
  casual contribution.
- **Some buyers will refuse Xmip on license grounds alone.** Accepted.
- **The boundary is unaffected.** `include/xmip_module.h` stays
  ...
  license exemption. ADR-0012 clause 9, unchanged.

## What was considered and rejected

**AGPL plus a commercial license**, as Grafana, Mattermost, Bitwarden and

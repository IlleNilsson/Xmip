...
### What a provider other than core builds against, where its license
...
→ [A provider builds against the capabilities; the SDK simulates, in full](ADR-0061-a-provider-builds-against-the-sdk.md)
